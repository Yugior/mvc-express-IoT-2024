...
exports.studentSchema = zod_1.z.object({
    ...
    email: zod_1.z.string().email({ message: "Debe ser un email válido" }),
    address: zod_1.z
        .string()
    ...
    grade_level: zod_1.z
        .string()
        .regex(/^\d+°$/, {
        message: "El formato de grade_level debe ser 'Número°' (por ejemplo, '10°')",
    })
        .refine((grade) => {
